            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <ColorPopover
                  ...
                  onChange={(color) => setEditedCourse({ ...editedCourse, color })}
                />
              </div>
              <div>
                <Label>Icono</Label>
                <div className="flex flex-wrap gap-2 mt-1">
                  {EMOJI_OPTIONS.map((emoji) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg border-2 text-xl flex items-center justify-center transition-all ${editedCourse.icon === emoji
